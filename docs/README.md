...
| [`docs/product/VALIDATION_AND_REVIEW.md`](product/VALIDATION_AND_REVIEW.md)         | Validation, pinned dependencies, review, fingerprint, and effect-gate guarantees; read before changing how work becomes acceptable |
